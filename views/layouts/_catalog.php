    ...
    <body id="Home">
        ...
        <div class="wrap">
            <div class="container-fluid">
                ...
                <div class="col-xs-12 col-sm-10 col-sm-offset-1 nsp-header-categories">
                ...
                <div class="col-xs-12 col-xs-offset-0 col-sm-10 col-sm-offset-1 nsp-search">
                    ...
                    <div class="nsp-search-form-input">
                        <input type="text" name="data" class="form-control" placeholder="Введите наименование..." autocomplete="off" oninput="SearchList(event)">
                    </div>
                    <button type="submit" class="btn btn-default">Найти</button>
                    <div id="search-list" class="col-xs-12 nsp-search-result-active-list" hidden>                    
                        <!--axaj query result-->
                    </div>
                    <!--</form>-->
                    <?php ActiveForm::end(); ?>

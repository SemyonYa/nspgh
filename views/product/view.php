    ...
    <div class="col-xs-12 nsp-product-description">
        <div class="col-xs-12 nsp-product-description-ti">
            ...
            <div class="nsp-product-description-img"
                 style="background-image: url('<?= \Yii::$app->imagemanager->getImagePath($product->img_id, '400', '400', 'inset') ?>');">

            </div>
        </div>
        <div class="col-xs-12 nsp-product-description-ab">
            <div class="panel-group nsp-product-description-accordeon" id="accordion" role="tablist"
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="panel-body">
                            <button class="btn btn-primary nsp-btn-buying" data-toggle="modal"
                                    data-target="#CommentModal">Оставить отзыв...
                            </button>
            ...
            <div class="col-xs-12 nsp-product-description-buy">
                <button class="btn btn-primary nsp-btn-buying" data-toggle="modal" data-target="#myModal">Быстрая
                    покупка
                </button>
                <?php if ($product_in_cart): ?>
                    <button class="btn btn-primary nsp-btn-buying">Товар уже в корзине</button>
                <?php else: ?>
                    <button id="ToCart" class="btn btn-primary nsp-btn-buying"
                            onclick="ProdToCart(<?= $product->id ?>)">В корзину
                    </button>
                <?php endif; ?>
            </div>
        </div>
